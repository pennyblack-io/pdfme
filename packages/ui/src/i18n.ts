...
const dictEn = {
  ...
  prefixInputExample: 'Prefix Input',
  suffixInputExample: 'Suffix Input',
  edit: 'Edit',
...
const dictJa: { [key in keyof DictEn]: string } = {
  ...
  uniq: '他の項目名と同一不可',
  inputExample: '記入例',
  prefixInputExample: 'プレフィックス入力',
  suffixInputExample: 'サフィックス入力',
  edit: '編集する',
...
const dictAr: { [key in keyof DictEn]: string } = {
  ...
  inputExample: 'مثال',
  prefixInputExample: 'إدخال البادئة',
  suffixInputExample: 'إدخال اللاحقة',
  edit: 'تعديل',
...
const dictTh: { [key in keyof DictEn]: string } = {
  ...
  prefixInputExample: 'ป้อนคำนำหน้า',
  suffixInputExample: 'ใส่คำต่อท้าย',
  edit: 'แก้ไข',
